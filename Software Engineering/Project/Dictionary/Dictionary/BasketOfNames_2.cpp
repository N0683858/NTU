...
void BasketOfNames_2::readResultData_intoList()
{
	...
	resultData.push_front(tempName); // most eastern neighbour
...
//	cin >> file;
//
//	//BasketOfNames_2 test = BasketOfNames_2("C:/Basket_of_Names-test_data/20/input-papers-20.txt");
//	BasketOfNames_2 test = BasketOfNames_2(file);
//	return 0;
//}
